            ...
            <div className="flex items-center gap-3 md:ml-2">
              <MagneticButton strength={10}>
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="GitHub"
                  className="inline-flex items-center justify-center p-3 rounded-xl border-2 border-slate-700 text-slate-300 hover:border-sky-400 hover:text-sky-400 hover:bg-sky-400/10 transition-all duration-300 hover:-translate-y-0.5 group"
                >
        ...
        >
          <div className="relative group">
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="hero-badge absolute -top-2 -right-4 z-20 hidden sm:block rounded-lg px-3 py-1.5 text-xs font-semibold text-sky-400 animate-float-slow shadow-lg"
            >
              ⚛️ React
            </motion.div>
            <motion.div
